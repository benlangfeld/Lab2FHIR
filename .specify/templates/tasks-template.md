...
- [ ] T004 Define constitution compliance checkpoints for this feature (determinism, schema,
  traceability, PHI/self-hosted constraints)
...
- [ ] T011 Add or update strict intermediate schema validation boundaries before conversion
- [ ] T012 Define deterministic identifier/normalization touchpoints impacted by this feature
...
- [ ] T021 [US1] Verify deterministic outputs for affected transforms (if applicable)
- [ ] T022 [US1] Verify source PDF/provenance preservation (if applicable)
...
- [ ] TXXX Re-run constitution compliance check and document outcomes in PR
